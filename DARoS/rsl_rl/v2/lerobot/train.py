...
def main():
    ...
    #dataset_metadata = LeRobotDatasetMetadata(repo_id="ssangjunpark/daros2", root=DATA_DIR)
    ...
    #dataset = LeRobotDataset(repo_id="ssangjunpark/daros2", delta_timestamps=delta_timestamps)
